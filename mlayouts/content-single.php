		...
		<?php if( $pfm == '' || $pfm == 'image' ){?>
			<?php if( has_post_thumbnail() ){ ?>
				<div class="entry-thumb single-thumb">
						<?php the_post_thumbnail('kontruk_blog_mobile');?>						
				</div>
			<?php }?>
		<?php } ?>
			...
			<div class="entry-meta clearfix">
				...
				<span class="entry-comment">
					<a href="<?php comments_link(); ?>">
						<?php echo sprintf( _n( '%d Comment', '%d Comments', $post-> comment_count, 'kontruk' ), $post-> comment_count ); ?>
					</a>
				</span>
			</div>
  ...
  <?php 
	...
	?>
			<div class="single-post-relate-mobile">
				<h4><?php esc_html_e('Related Posts', 'kontruk'); ?></h4>
				<?php
				...
				?>
					<div <?php post_class( $class_col ); ?> >
						...
						<div class="item-relate-img">
							<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('kontruk_related_mobile'); ?></a>
						</div>
						<?php } ?>
